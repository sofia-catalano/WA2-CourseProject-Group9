...
class WebSecurityConfig {
    ...
    fun securityWebFilterChain(http: ServerHttpSecurity): SecurityWebFilterChain? {
        ...
        return http
            ...
            .csrf().disable()
            .authorizeExchange()
            .pathMatchers("/catalogue/tickets").permitAll()
            .and()
            .addFilterAt(authorizationFilter, SecurityWebFiltersOrder.AUTHORIZATION)
            .authorizeExchange()
            .pathMatchers("/catalogue/shop/**").hasAuthority("ROLE_CUSTOMER")
            .pathMatchers("/catalogue/orders/**").hasAuthority("ROLE_CUSTOMER")
            .pathMatchers("/catalogue/admin/**").hasAuthority("ROLE_ADMIN")
            .and()
            .exceptionHandling()
